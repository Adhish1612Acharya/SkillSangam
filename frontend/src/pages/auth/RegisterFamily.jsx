  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await signUp({
        ...
        adhaarNumber: formData.soldierId, // or use a separate adhaar field if available
        familyCode: formData.familyCode,
        password: formData.password,
        email: formData.email,
        username: formData.name, // or formData.name if you want
          ...
          <StyledPaper elevation={3}>
            ...
            >
              ...
              <Typography
                component="h1"
                variant="h4"
                sx={{ mt: 2, fontWeight: "bold", color: "secondary.dark" }}
              >
