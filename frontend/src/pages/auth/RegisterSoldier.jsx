...
const RegisterSoldier = () => {
  ...
  const addFamilyMember = () => {
    if (!currentFamilyMember.name || !currentFamilyMember.adhaar) {
      setError("Name and Aadhaar are required for family member");
      return;
    }

    setFamilyMembers((prev) => [
      ...prev,
      { ...currentFamilyMember, id: Date.now() },
    ]);
    setCurrentFamilyMember({ name: "", adhaar: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call backend API for personnel registration
      formData.familyFullName = currentFamilyMember.name || "";
      formData.familyAdhaarNumber = currentFamilyMember.adhaar || "";
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body1" sx={{ mb: 2 }}>
                    Share this code with your family members to allow them to
                    register under your account:
                  </Typography>
                  <Chip
                    label={familyCode}
                    color="primary"
                    ...
                    <Grid container spacing={2}>
                      ...
                      >
                        <TextField
                          ...
                          name="adhaar"
                          value={currentFamilyMember.adhaar}
                          onChange={handleFamilyMemberChange}
                          variant="outlined"
                          required
                        />
