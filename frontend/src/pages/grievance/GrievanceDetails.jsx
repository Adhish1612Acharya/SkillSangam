...
import { ArrowLeft, Clock, CheckCircle, XCircle, AlertCircle, ChevronUp, Mail, Phone } from 'lucide-react'
...
const GrievanceDetails = () => {
  ...
  const grievance = {
    ...
    contactEmail: 'pension-helpdesk@mod.gov.in',
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'Under Review': return <AlertCircle className="w-5 h-5 text-blue-500" />
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 p-2 bg-blue-50 rounded">
                ...
                <span className="text-blue-700">{grievance.contactEmail}</span>
              </div>
              <div className="flex items-center gap-2 p-2 bg-blue-50 rounded">
                <Phone className="w-5 h-5 text-blue-600" />
                <span className="text-blue-700">{grievance.contactPhone}</span>
              </div>
            </div>
          </Card>
          ...
          {grievance.status !== 'Resolved' && (
            <Card className="border-l-4 border-red-500">
              <h2 className="text-xl font-semibold mb-3">Escalate</h2>
              <p className="text-gray-600 mb-4 text-sm">
                If unresolved, you may escalate this grievance to higher authorities.
              </p>
